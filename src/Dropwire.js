...
class Cable extends React.Component {
  ...
  }; //Aren't every successful software entrepreneurs' actual first business usually either a money service or payment processors first?
  //Why would you go public if you can only own 20%?
